...
`Phase 0 → Phase 1 → Phase 2 → Phase 2+ → Phase 3 → Phase 4 → Phase 5 → Phase 6 → Phase 7`

Phase 1, Phase 2, and Phase 2+ are complete. Phase 3 is the next implementation
phase. This is an experimental hobby project, not a tagged release or stable
API.
...
6. Component/backend separation.
7. Multiple option-scoring workers.
8. Request pipeline scheduler.
9. Scheduler tuning.
